...
class Talo:
    ...
    def palohälytys(self):
        print("Palohälytys, kaikki hissit palaa alimpaan kerrokseen.")
        for x in range(self.hissi_lkm):
            self.hissit[x].siirry_kerrokseen(1)
...
while True:
    ...
    if hissi_selection <= 0:
        ...
        break
    elif hissi_selection == 9999: # Hissit palaa alimpaan kerrokseen syöttämällä hissinro 9999
        talo.palohälytys()
        break
